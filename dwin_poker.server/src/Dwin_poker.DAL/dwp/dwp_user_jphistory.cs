...
namespace Dwin_poker.DAL
{
	...
	/// <summary>
	/// jp中奖记录
	/// 【表 dwp_user_jphistory 的实体类】
	/// </summary>
	[DataContract]
	[Obsolete]
	public class Dwp_user_jphistoryEO : IRowMapper<Dwp_user_jphistoryEO>
	{
		/// <summary>
		/// 构造函数 
		/// </summary>
		public Dwp_user_jphistoryEO()
		{
			this.WinAmount = 0;
		...
		/// <return>实体对象</return>
		public Dwp_user_jphistoryEO MapRow(IDataReader reader)
		{
		...
		/// <param name = "reader">只进结果集流</param>
		/// <return>实体对象</return>
		public static Dwp_user_jphistoryEO MapDataReader(IDataReader reader)
		{
		    Dwp_user_jphistoryEO ret = new Dwp_user_jphistoryEO();
	...
	/// <summary>
	/// jp中奖记录
	/// 【表 dwp_user_jphistory 的操作类】
	/// </summary>
	[Obsolete]
	public class Dwp_user_jphistoryMO : MySqlTableMO<Dwp_user_jphistoryEO>
	{
		/// <summary>
		/// 表名
		/// </summary>
	    public override string TableName { get; set; } = "`dwp_user_jphistory`";
		...
		public Dwp_user_jphistoryMO(MySqlDatabase database) : base(database) { }
		/// <summary>
		/// 构造函数
		/// </summary>
		/// <param name = "connectionStringName">配置文件.config中定义的连接字符串名称</param>
		public Dwp_user_jphistoryMO(string connectionStringName = null) : base(connectionStringName) { }
	    /// <summary>
	    /// 构造函数
	    /// </summary>
	    /// <param name="connectionString">数据库连接字符串，如server=192.168.1.1;database=testdb;uid=root;pwd=root</param>
	    /// <param name="commandTimeout">CommandTimeout时间</param>
	    public Dwp_user_jphistoryMO(string connectionString, int commandTimeout) : base(connectionString, commandTimeout) { }
		...
		public override int Add(Dwp_user_jphistoryEO item, TransactionManager tm_ = null, bool useIgnore_ = false)
		{
			RepairAddData(item, useIgnore_, out string sql_, out List<MySqlParameter> paras_);
			return Database.ExecSqlNonQuery(sql_, paras_, tm_); 
		}
		public override async Task<int> AddAsync(Dwp_user_jphistoryEO item, TransactionManager tm_ = null, bool useIgnore_ = false)
		{
			RepairAddData(item, useIgnore_, out string sql_, out List<MySqlParameter> paras_);
			return await Database.ExecSqlNonQueryAsync(sql_, paras_, tm_); 
		}
	    private void RepairAddData(Dwp_user_jphistoryEO item, bool useIgnore_, out string sql_, out List<MySqlParameter> paras_)
		{
		...
		public int AddByBatch(IEnumerable<Dwp_user_jphistoryEO> items, int batchCount, TransactionManager tm_ = null)
		{
			var ret = 0;
	    ...
	    public async Task<int> AddByBatchAsync(IEnumerable<Dwp_user_jphistoryEO> items, int batchCount, TransactionManager tm_ = null)
	    {
	        var ret = 0;
	        foreach (var sql in BuildAddBatchSql(items, batchCount))
	        {
	    ...
	    private IEnumerable<string> BuildAddBatchSql(IEnumerable<Dwp_user_jphistoryEO> items, int batchCount)
		{
			var count = 0;
		...
		/// <param name="tm_">事务管理对象</param>
		/// <return>受影响的行数</return>
		public int Remove(Dwp_user_jphistoryEO item, TransactionManager tm_ = null)
		{
			return RemoveByPK(item.HID, tm_);
		}
		public async Task<int> RemoveAsync(Dwp_user_jphistoryEO item, TransactionManager tm_ = null)
		{
		...
		/// <param name="tm_">事务管理对象</param>
		/// <return>受影响的行数</return>
		public int Put(Dwp_user_jphistoryEO item, TransactionManager tm_ = null)
		{
			RepairPutData(item, out string sql_, out List<MySqlParameter> paras_);
			return Database.ExecSqlNonQuery(sql_, paras_, tm_);
		}
		public async Task<int> PutAsync(Dwp_user_jphistoryEO item, TransactionManager tm_ = null)
		{
			RepairPutData(item, out string sql_, out List<MySqlParameter> paras_);
			return await Database.ExecSqlNonQueryAsync(sql_, paras_, tm_);
		}
		private void RepairPutData(Dwp_user_jphistoryEO item, out string sql_, out List<MySqlParameter> paras_)
		{
		...
		/// <param name="tm_">事务管理对象</param>
		/// <return>受影响的行数</return>
		public int Put(IEnumerable<Dwp_user_jphistoryEO> items, TransactionManager tm_ = null)
		{
			int ret = 0;
			foreach (var item in items)
			{
		...
		public async Task<int> PutAsync(IEnumerable<Dwp_user_jphistoryEO> items, TransactionManager tm_ = null)
		{
			int ret = 0;
			foreach (var item in items)
			{
		...
		public bool Set(Dwp_user_jphistoryEO item, TransactionManager tm = null)
		{
			bool ret = true;
		...
		public async Task<bool> SetAsync(Dwp_user_jphistoryEO item, TransactionManager tm = null)
		{
			bool ret = true;
			if(GetByPK(item.HID) == null)
			{
		...
		/// <return></return>
		public Dwp_user_jphistoryEO GetByPK(long hID, TransactionManager tm_ = null, bool isForUpdate_ = false)
		{
			RepairGetByPKData(hID, out string sql_, out List<MySqlParameter> paras_, isForUpdate_, tm_);
			return Database.ExecSqlSingle(sql_, paras_, tm_, Dwp_user_jphistoryEO.MapDataReader);
		}
		public async Task<Dwp_user_jphistoryEO> GetByPKAsync(long hID, TransactionManager tm_ = null, bool isForUpdate_ = false)
		{
			RepairGetByPKData(hID, out string sql_, out List<MySqlParameter> paras_, isForUpdate_, tm_);
			return await Database.ExecSqlSingleAsync(sql_, paras_, tm_, Dwp_user_jphistoryEO.MapDataReader);
		}
		...
		public List<Dwp_user_jphistoryEO> GetByCurrencyID(string currencyID)
		{
			return GetByCurrencyID(currencyID, 0, string.Empty, null);
		}
		public async Task<List<Dwp_user_jphistoryEO>> GetByCurrencyIDAsync(string currencyID)
		{
		...
		/// <param name="tm_">事务管理对象</param>
		/// <return>实体对象集合</return>
		public List<Dwp_user_jphistoryEO> GetByCurrencyID(string currencyID, TransactionManager tm_)
		{
			return GetByCurrencyID(currencyID, 0, string.Empty, tm_);
		}
		public async Task<List<Dwp_user_jphistoryEO>> GetByCurrencyIDAsync(string currencyID, TransactionManager tm_)
		{
		...
		/// <return>实体对象集合</return>
		public List<Dwp_user_jphistoryEO> GetByCurrencyID(string currencyID, int top_)
		{
			return GetByCurrencyID(currencyID, top_, string.Empty, null);
		}
		public async Task<List<Dwp_user_jphistoryEO>> GetByCurrencyIDAsync(string currencyID, int top_)
		{
		...
		/// <param name="tm_">事务管理对象</param>
		/// <return>实体对象集合</return>
		public List<Dwp_user_jphistoryEO> GetByCurrencyID(string currencyID, int top_, TransactionManager tm_)
		{
			return GetByCurrencyID(currencyID, top_, string.Empty, tm_);
		}
		public async Task<List<Dwp_user_jphistoryEO>> GetByCurrencyIDAsync(string currencyID, int top_, TransactionManager tm_)
		{
		...
		/// <return>实体对象集合</return>
		public List<Dwp_user_jphistoryEO> GetByCurrencyID(string currencyID, string sort_)
		{
			return GetByCurrencyID(currencyID, 0, sort_, null);
		}
		public async Task<List<Dwp_user_jphistoryEO>> GetByCurrencyIDAsync(string currencyID, string sort_)
		{
		...
		/// <param name="tm_">事务管理对象</param>
		/// <return>实体对象集合</return>
		public List<Dwp_user_jphistoryEO> GetByCurrencyID(string currencyID, string sort_, TransactionManager tm_)
		{
			return GetByCurrencyID(currencyID, 0, sort_, tm_);
		}
		public async Task<List<Dwp_user_jphistoryEO>> GetByCurrencyIDAsync(string currencyID, string sort_, TransactionManager tm_)
		{
		...
		/// <param name="tm_">事务管理对象</param>
		/// <return>实体对象集合</return>
		public List<Dwp_user_jphistoryEO> GetByCurrencyID(string currencyID, int top_, string sort_, TransactionManager tm_)
		{
			var sql_ = BuildSelectSQL("`CurrencyID` = @CurrencyID", top_, sort_);
			var paras_ = new List<MySqlParameter>();
			paras_.Add(Database.CreateInParameter("@CurrencyID", currencyID, MySqlDbType.VarChar));
			return Database.ExecSqlList(sql_, paras_, tm_, Dwp_user_jphistoryEO.MapDataReader);
		}
		public async Task<List<Dwp_user_jphistoryEO>> GetByCurrencyIDAsync(string currencyID, int top_, string sort_, TransactionManager tm_)
		{
			var sql_ = BuildSelectSQL("`CurrencyID` = @CurrencyID", top_, sort_);
			var paras_ = new List<MySqlParameter>();
			paras_.Add(Database.CreateInParameter("@CurrencyID", currencyID, MySqlDbType.VarChar));
			return await Database.ExecSqlListAsync(sql_, paras_, tm_, Dwp_user_jphistoryEO.MapDataReader);
		}
		...
		/// /// <param name = "userID">用户Id</param>
		/// <return>实体对象集合</return>
		public List<Dwp_user_jphistoryEO> GetByUserID(string userID)
		{
			return GetByUserID(userID, 0, string.Empty, null);
		}
		public async Task<List<Dwp_user_jphistoryEO>> GetByUserIDAsync(string userID)
		{
		...
		/// <param name="tm_">事务管理对象</param>
		/// <return>实体对象集合</return>
		public List<Dwp_user_jphistoryEO> GetByUserID(string userID, TransactionManager tm_)
		{
			return GetByUserID(userID, 0, string.Empty, tm_);
		}
		public async Task<List<Dwp_user_jphistoryEO>> GetByUserIDAsync(string userID, TransactionManager tm_)
		{
		...
		/// <param name = "top_">获取行数</param>
		/// <return>实体对象集合</return>
		public List<Dwp_user_jphistoryEO> GetByUserID(string userID, int top_)
		{
			return GetByUserID(userID, top_, string.Empty, null);
		}
		public async Task<List<Dwp_user_jphistoryEO>> GetByUserIDAsync(string userID, int top_)
		{
		...
		/// <param name="tm_">事务管理对象</param>
		/// <return>实体对象集合</return>
		public List<Dwp_user_jphistoryEO> GetByUserID(string userID, int top_, TransactionManager tm_)
		{
			return GetByUserID(userID, top_, string.Empty, tm_);
		}
		public async Task<List<Dwp_user_jphistoryEO>> GetByUserIDAsync(string userID, int top_, TransactionManager tm_)
		{
		...
		/// <param name = "sort_">排序表达式</param>
		/// <return>实体对象集合</return>
		public List<Dwp_user_jphistoryEO> GetByUserID(string userID, string sort_)
		{
			return GetByUserID(userID, 0, sort_, null);
		}
		public async Task<List<Dwp_user_jphistoryEO>> GetByUserIDAsync(string userID, string sort_)
		{
		...
		/// <param name="tm_">事务管理对象</param>
		/// <return>实体对象集合</return>
		public List<Dwp_user_jphistoryEO> GetByUserID(string userID, string sort_, TransactionManager tm_)
		{
			return GetByUserID(userID, 0, sort_, tm_);
		}
		public async Task<List<Dwp_user_jphistoryEO>> GetByUserIDAsync(string userID, string sort_, TransactionManager tm_)
		{
		...
		/// <param name="tm_">事务管理对象</param>
		/// <return>实体对象集合</return>
		public List<Dwp_user_jphistoryEO> GetByUserID(string userID, int top_, string sort_, TransactionManager tm_)
		{
		...
		public async Task<List<Dwp_user_jphistoryEO>> GetByUserIDAsync(string userID, int top_, string sort_, TransactionManager tm_)
		{
			var sql_ = BuildSelectSQL("`UserID` = @UserID", top_, sort_);
			var paras_ = new List<MySqlParameter>();
			paras_.Add(Database.CreateInParameter("@UserID", userID, MySqlDbType.VarChar));
		...
		/// /// <param name = "userMobile">用户昵称或者手机号</param>
		/// <return>实体对象集合</return>
		public List<Dwp_user_jphistoryEO> GetByUserMobile(string userMobile)
		{
			return GetByUserMobile(userMobile, 0, string.Empty, null);
		}
		public async Task<List<Dwp_user_jphistoryEO>> GetByUserMobileAsync(string userMobile)
		{
		...
		/// <param name="tm_">事务管理对象</param>
		/// <return>实体对象集合</return>
		public List<Dwp_user_jphistoryEO> GetByUserMobile(string userMobile, TransactionManager tm_)
		{
			return GetByUserMobile(userMobile, 0, string.Empty, tm_);
		}
		public async Task<List<Dwp_user_jphistoryEO>> GetByUserMobileAsync(string userMobile, TransactionManager tm_)
		{
		...
		/// <param name = "top_">获取行数</param>
		/// <return>实体对象集合</return>
		public List<Dwp_user_jphistoryEO> GetByUserMobile(string userMobile, int top_)
		{
			return GetByUserMobile(userMobile, top_, string.Empty, null);
		}
		public async Task<List<Dwp_user_jphistoryEO>> GetByUserMobileAsync(string userMobile, int top_)
		{
		...
		/// <param name="tm_">事务管理对象</param>
		/// <return>实体对象集合</return>
		public List<Dwp_user_jphistoryEO> GetByUserMobile(string userMobile, int top_, TransactionManager tm_)
		{
			return GetByUserMobile(userMobile, top_, string.Empty, tm_);
		}
		public async Task<List<Dwp_user_jphistoryEO>> GetByUserMobileAsync(string userMobile, int top_, TransactionManager tm_)
		{
		...
		/// <param name = "sort_">排序表达式</param>
		/// <return>实体对象集合</return>
		public List<Dwp_user_jphistoryEO> GetByUserMobile(string userMobile, string sort_)
		{
			return GetByUserMobile(userMobile, 0, sort_, null);
		}
		public async Task<List<Dwp_user_jphistoryEO>> GetByUserMobileAsync(string userMobile, string sort_)
		{
		...
		/// <param name="tm_">事务管理对象</param>
		/// <return>实体对象集合</return>
		public List<Dwp_user_jphistoryEO> GetByUserMobile(string userMobile, string sort_, TransactionManager tm_)
		{
			return GetByUserMobile(userMobile, 0, sort_, tm_);
		}
		public async Task<List<Dwp_user_jphistoryEO>> GetByUserMobileAsync(string userMobile, string sort_, TransactionManager tm_)
		{
		...
		/// <param name="tm_">事务管理对象</param>
		/// <return>实体对象集合</return>
		public List<Dwp_user_jphistoryEO> GetByUserMobile(string userMobile, int top_, string sort_, TransactionManager tm_)
		{
		...
		public async Task<List<Dwp_user_jphistoryEO>> GetByUserMobileAsync(string userMobile, int top_, string sort_, TransactionManager tm_)
		{
			var sql_ = BuildSelectSQL("`UserMobile` = @UserMobile", top_, sort_);
			var paras_ = new List<MySqlParameter>();
			paras_.Add(Database.CreateInParameter("@UserMobile", userMobile, MySqlDbType.VarChar));
		...
		/// /// <param name = "winAmount">奖金</param>
		/// <return>实体对象集合</return>
		public List<Dwp_user_jphistoryEO> GetByWinAmount(long winAmount)
		{
			return GetByWinAmount(winAmount, 0, string.Empty, null);
		}
		public async Task<List<Dwp_user_jphistoryEO>> GetByWinAmountAsync(long winAmount)
		{
		...
		/// <param name="tm_">事务管理对象</param>
		/// <return>实体对象集合</return>
		public List<Dwp_user_jphistoryEO> GetByWinAmount(long winAmount, TransactionManager tm_)
		{
			return GetByWinAmount(winAmount, 0, string.Empty, tm_);
		}
		public async Task<List<Dwp_user_jphistoryEO>> GetByWinAmountAsync(long winAmount, TransactionManager tm_)
		{
		...
		/// <param name = "top_">获取行数</param>
		/// <return>实体对象集合</return>
		public List<Dwp_user_jphistoryEO> GetByWinAmount(long winAmount, int top_)
		{
			return GetByWinAmount(winAmount, top_, string.Empty, null);
		}
		public async Task<List<Dwp_user_jphistoryEO>> GetByWinAmountAsync(long winAmount, int top_)
		{
		...
		/// <param name="tm_">事务管理对象</param>
		/// <return>实体对象集合</return>
		public List<Dwp_user_jphistoryEO> GetByWinAmount(long winAmount, int top_, TransactionManager tm_)
		{
			return GetByWinAmount(winAmount, top_, string.Empty, tm_);
		}
		public async Task<List<Dwp_user_jphistoryEO>> GetByWinAmountAsync(long winAmount, int top_, TransactionManager tm_)
		{
		...
		/// <param name = "sort_">排序表达式</param>
		/// <return>实体对象集合</return>
		public List<Dwp_user_jphistoryEO> GetByWinAmount(long winAmount, string sort_)
		{
			return GetByWinAmount(winAmount, 0, sort_, null);
		}
		public async Task<List<Dwp_user_jphistoryEO>> GetByWinAmountAsync(long winAmount, string sort_)
		{
		...
		/// <param name="tm_">事务管理对象</param>
		/// <return>实体对象集合</return>
		public List<Dwp_user_jphistoryEO> GetByWinAmount(long winAmount, string sort_, TransactionManager tm_)
		{
			return GetByWinAmount(winAmount, 0, sort_, tm_);
		}
		public async Task<List<Dwp_user_jphistoryEO>> GetByWinAmountAsync(long winAmount, string sort_, TransactionManager tm_)
		{
		...
		/// <param name="tm_">事务管理对象</param>
		/// <return>实体对象集合</return>
		public List<Dwp_user_jphistoryEO> GetByWinAmount(long winAmount, int top_, string sort_, TransactionManager tm_)
		{
		...
		public async Task<List<Dwp_user_jphistoryEO>> GetByWinAmountAsync(long winAmount, int top_, string sort_, TransactionManager tm_)
		{
			var sql_ = BuildSelectSQL("`WinAmount` = @WinAmount", top_, sort_);
			var paras_ = new List<MySqlParameter>();
			paras_.Add(Database.CreateInParameter("@WinAmount", winAmount, MySqlDbType.Int64));
		...
		/// /// <param name = "recDate">记录时间</param>
		/// <return>实体对象集合</return>
		public List<Dwp_user_jphistoryEO> GetByRecDate(DateTime recDate)
		{
			return GetByRecDate(recDate, 0, string.Empty, null);
		}
		public async Task<List<Dwp_user_jphistoryEO>> GetByRecDateAsync(DateTime recDate)
		{
		...
		/// <param name="tm_">事务管理对象</param>
		/// <return>实体对象集合</return>
		public List<Dwp_user_jphistoryEO> GetByRecDate(DateTime recDate, TransactionManager tm_)
		{
			return GetByRecDate(recDate, 0, string.Empty, tm_);
		}
		public async Task<List<Dwp_user_jphistoryEO>> GetByRecDateAsync(DateTime recDate, TransactionManager tm_)
		{
		...
		/// <param name = "top_">获取行数</param>
		/// <return>实体对象集合</return>
		public List<Dwp_user_jphistoryEO> GetByRecDate(DateTime recDate, int top_)
		{
			return GetByRecDate(recDate, top_, string.Empty, null);
		}
		public async Task<List<Dwp_user_jphistoryEO>> GetByRecDateAsync(DateTime recDate, int top_)
		{
		...
		/// <param name="tm_">事务管理对象</param>
		/// <return>实体对象集合</return>
		public List<Dwp_user_jphistoryEO> GetByRecDate(DateTime recDate, int top_, TransactionManager tm_)
		{
			return GetByRecDate(recDate, top_, string.Empty, tm_);
		}
		public async Task<List<Dwp_user_jphistoryEO>> GetByRecDateAsync(DateTime recDate, int top_, TransactionManager tm_)
		{
		...
		/// <param name = "sort_">排序表达式</param>
		/// <return>实体对象集合</return>
		public List<Dwp_user_jphistoryEO> GetByRecDate(DateTime recDate, string sort_)
		{
			return GetByRecDate(recDate, 0, sort_, null);
		}
		public async Task<List<Dwp_user_jphistoryEO>> GetByRecDateAsync(DateTime recDate, string sort_)
		{
		...
		/// <param name="tm_">事务管理对象</param>
		/// <return>实体对象集合</return>
		public List<Dwp_user_jphistoryEO> GetByRecDate(DateTime recDate, string sort_, TransactionManager tm_)
		{
			return GetByRecDate(recDate, 0, sort_, tm_);
		}
		public async Task<List<Dwp_user_jphistoryEO>> GetByRecDateAsync(DateTime recDate, string sort_, TransactionManager tm_)
		{
		...
		/// <param name="tm_">事务管理对象</param>
		/// <return>实体对象集合</return>
		public List<Dwp_user_jphistoryEO> GetByRecDate(DateTime recDate, int top_, string sort_, TransactionManager tm_)
		{
		...
		public async Task<List<Dwp_user_jphistoryEO>> GetByRecDateAsync(DateTime recDate, int top_, string sort_, TransactionManager tm_)
		{
			var sql_ = BuildSelectSQL("`RecDate` = @RecDate", top_, sort_);
			var paras_ = new List<MySqlParameter>();
			paras_.Add(Database.CreateInParameter("@RecDate", recDate, MySqlDbType.DateTime));
